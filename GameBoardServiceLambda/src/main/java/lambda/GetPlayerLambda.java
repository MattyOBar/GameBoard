...
public class GetPlayerLambda extends LambdaActivityRunner<GetPlayerRequest, GetPlayerResult> implements RequestHandler<LambdaRequest<GetPlayerRequest>, LambdaResponse> {
